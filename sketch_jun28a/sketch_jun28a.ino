...
if ( 
    lampuSensor1 == mati && lampuSensor2 == mati && lampuSensor3 == mati && lampuSensor4 == mati && lampuSensor5 == mati ||
...
// Kondisi yang menjadikan mobil belok ke kiri
 ...
 lampuSensor1 == mati && lampuSensor2 == mati && lampuSensor3 == mati && lampuSensor4 == menyala && lampuSensor5 == menyala ||
 lampuSensor1 == mati && lampuSensor2 == mati && lampuSensor3 == menyala && lampuSensor4 == menyala && lampuSensor5 == menyala){
 Serial.println("Belok kiri");
  motor1.setSpeed(180);
   motor2.setSpeed(0);
   motor1.run(BACKWARD);
...
// Kondisi yang menjadikan mobil belok ke kanan 
  ...
  lampuSensor1 == menyala && lampuSensor2 == menyala && lampuSensor3 == menyala && lampuSensor4 == menyala && lampuSensor5 == mati ||
  lampuSensor1 == menyala && lampuSensor2 == mati && lampuSensor3 == mati && lampuSensor4 == mati && lampuSensor5 == mati ){
...
lampuSensor1 == menyala && lampuSensor2 == menyala && lampuSensor3 == menyala && lampuSensor4 == mati && lampuSensor5 == mati  ||
lampuSensor1 == menyala && lampuSensor2 == menyala && lampuSensor3 == mati && lampuSensor4 == mati && lampuSensor5 == mati ){
Serial.println("Belok kanan");
motor1.setSpeed(0);
motor2.setSpeed(180);
motor2.run(BACKWARD);
...
else if (  lampuSensor1 == mati && lampuSensor2 == mati && lampuSensor3 == menyala && lampuSensor4 == menyala && lampuSensor5 == mati ||
